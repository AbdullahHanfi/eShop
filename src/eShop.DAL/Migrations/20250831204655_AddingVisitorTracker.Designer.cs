...
namespace eShop.DAL.Migrations
{
    ...
    [Migration("20250831204655_AddingVisitorTracker")]
    partial class AddingVisitorTracker
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("eShop.Core.Entities.VisitorHistory", "Histories", b1 =>
                        {
                            ...
                            b1.Property<string>("VisitorIpAddress")
                                .IsRequired()
                                .HasColumnType("nvarchar(450)");

                            b1.HasKey("Id");

                            b1.HasIndex("VisitorIpAddress");

                            b1.ToTable("VisitorHistory");

                            b1.WithOwner()
                                .HasForeignKey("VisitorIpAddress");
                        });
